// Generated from /home2/users/alumnes/1253874/dades/CL-Projecte/Asl.g4 by ANTLR 4.13.1
...
public class AslParser extends Parser {
	...
	public static final int
		...
		T__9=10, ASSIGN=11, EQUAL=12, NE=13, GT=14, GE=15, LT=16, LE=17, PLUS=18, 
		MINUS=19, DIV=20, MUL=21, MODULO=22, VAR=23, ARRAY=24, OF=25, INT=26, 
		FLOAT=27, BOOL=28, CHAR=29, IF=30, THEN=31, ELSE=32, ENDIF=33, WHILE=34, 
		DO=35, ENDWHILE=36, FUNC=37, ENDFUNC=38, READ=39, WRITE=40, RETURN=41, 
		TRY=42, ENDTRY=43, CATCH=44, THROW=45, AND=46, OR=47, NOT=48, INTVAL=49, 
		BOOLVAL=50, FLOATVAL=51, CHARVAL=52, ID=53, STRING=54, COMMENT=55, WS=56;
	public static final int
		...
		RULE_arrayExpr = 12, RULE_ident = 13;
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'try'", "'endtry'", "'catch'", "'throw'", "'and'", "'or'", "'not'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"EQUAL", "NE", "GT", "GE", "LT", "LE", "PLUS", "MINUS", "DIV", "MUL", 
			"MODULO", "VAR", "ARRAY", "OF", "INT", "FLOAT", "BOOL", "CHAR", "IF", 
			"THEN", "ELSE", "ENDIF", "WHILE", "DO", "ENDWHILE", "FUNC", "ENDFUNC", 
			"READ", "WRITE", "RETURN", "TRY", "ENDTRY", "CATCH", "THROW", "AND", 
			"OR", "NOT", "INTVAL", "BOOLVAL", "FLOATVAL", "CHARVAL", "ID", "STRING", 
			"COMMENT", "WS"
		};
	}
	...
	public static class TryStmtContext extends StatementContext {
		...
		public TerminalNode ENDTRY() { return getToken(AslParser.ENDTRY, 0); }
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
	...
	public static class ThrowStmtContext extends StatementContext {
		public TerminalNode THROW() { return getToken(AslParser.THROW, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17732923533558018L) != 0)) {
					{
					setState(120);
					expr(0);
					setState(125);
			...
			case 10:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17732923533558018L) != 0)) {
					{
					{
					setState(156);
					expr(0);
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ArrayExprCContext extends ExprContext {
		...
		public ArrayExprCContext(ExprContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 281474977497088L) != 0)) ) {
			...
			case 10:
				{
				_localctx = new ArrayExprCContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(208);
				arrayExpr();

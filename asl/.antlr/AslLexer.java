...
public class AslLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "ASSIGN", "AND", 
			"OR", "NOT", "EQUAL", "NE", "GT", "GE", "LT", "LE", "PLUS", "MINUS", 
			"DIV", "MUL", "MODULO", "VAR", "ARRAY", "OF", "INT", "FLOAT", "BOOL", 
			"CHAR", "IF", "THEN", "ELSE", "ENDIF", "WHILE", "DO", "ENDWHILE", "FUNC", 
			"ENDFUNC", "READ", "WRITE", "RETURN", "INTVAL", "TRUEVAL", "FALSEVAL", 
